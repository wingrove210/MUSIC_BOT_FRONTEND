  ...
  return (
    <form className="survey-form" onSubmit={handleSubmit}>
      ...
      <label>
        ...
        {errors.timeApart && <span className="error">{errors.timeApart}</span>}
      </label>
      <label>
        ...
        {errors.lastDayTogether && <span className="error">{errors.lastDayTogether}</span>}
      </label>
      <label>
        ...
        {errors.firstWords && <span className="error">{errors.firstWords}</span>}
      </label>
      ...
      <label>
        ...
        {errors.hardestPart && <span className="error">{errors.hardestPart}</span>}
      </label>
      <label>
        ...
        {errors.stayingConnected && <span className="error">{errors.stayingConnected}</span>}
      </label>
      <label>
        ...
        {errors.cherishedMoments && <span className="error">{errors.cherishedMoments}</span>}
      </label>
      <label>
        ...
        {errors.supportiveWords && <span className="error">{errors.supportiveWords}</span>}
      </label>
      <label>
        ...
        {errors.sourceOfStrength && <span className="error">{errors.sourceOfStrength}</span>}
      </label>
      ...
      <label>
        ...
        {errors.specialThing && <span className="error">{errors.specialThing}</span>}
      </label>
      <label>
        ...
        {errors.cherishedThings && <span className="error">{errors.cherishedThings}</span>}
      </label>
      <label>
        ...
        {errors.describeLovedOnes && <span className="error">{errors.describeLovedOnes}</span>}
      </label>
      ...
      <label>
        ...
        {errors.unspokenWords && <span className="error">{errors.unspokenWords}</span>}
      </label>
      <label>
        ...
        {errors.sharedDream && <span className="error">{errors.sharedDream}</span>}
      </label>
      <label>
        ...
        {errors.reunionMoment && <span className="error">{errors.reunionMoment}</span>}
      </label>
      ...
      <label>
        ...
        {errors.emotionalTone && <span className="error">{errors.emotionalTone}</span>}
      </label>
      <label>
        ...
        {errors.musicalStyle && <span className="error">{errors.musicalStyle}</span>}
      </label>
      <label>
        ...
        {errors.essentialWords && <span className="error">{errors.essentialWords}</span>}
      </label>
      <label>
        ...
        {errors.desiredEmotions && <span className="error">{errors.desiredEmotions}</span>}
      </label>
